...
const cardVariants = cva("rounded-lg border bg-card text-card-foreground shadow-sm", {
  variants: {
    variant: {
      ...
      interactive: "hover:shadow-md hover:border-primary/50 cursor-pointer transition-all",
      gradient: "bg-gradient-to-br from-primary/5 to-chart-2/5 border-primary/20",
    },
  },
  defaultVariants: {
    variant: "default",
...
const EnhancedCard = React.forwardRef<HTMLDivElement, EnhancedCardProps>(({ className, variant, ...props }, ref) => (
